...
gameOver.prototype = {
    create: function () {
        ...
        var results = this.game.add.text(this.game.world.centerX * 0.75,this.game.world.centerY, 'Tu puntaje es ' + localStorage.getItem('highScore'), { fontSize: '15px', fill: '#fff', boundsAlignH: "center", boundsAlignV: "middle" } )
        
        this.button = this.game.add.button(this.game.world.centerX/2,this.game.world.centerY + 50 ,'startAgain', this.playGame,this)
